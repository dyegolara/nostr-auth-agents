'use strict';
// TEST-ONLY ORACLE — the original hand-written secp256k1 + BIP-340 schnorr
// implementation, kept solely to cross-check the vendored @noble/curves code
// (lib/schnorr.js). Not imported by any runtime path.
//
